...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Optional: Add a pulse animation behind the button */}
      <span className="absolute w-full h-full rounded-full border-2 border-[#25D366] -z-10 animate-ping opacity-75"></span>
      {/* Optional: Add a notification badge like in the screenshot */}

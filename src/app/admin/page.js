            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pl-10 pr-10 py-3 bg-[#0b0d12] border rounded-lg focus:outline-none focus:ring-1 focus:ring-[#c9a04a] focus:border-[#c9a04a] transition-all text-[#f2eee3] placeholder-[#5c606c] ${
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#5c606c] hover:text-[#c9a04a] transition-colors"
                >
                  {showPassword ? (
